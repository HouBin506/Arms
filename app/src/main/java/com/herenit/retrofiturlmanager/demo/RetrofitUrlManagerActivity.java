 ...
 */
package com.herenit.retrofiturlmanager.demo;
...
import static com.herenit.retrofiturlmanager.demo.api.Api.GITHUB_DOMAIN_NAME;
 ...
 * ================================================
 */
public class RetrofitUrlManagerActivity extends AppCompatActivity {
    ...
    private void initView() {
        setContentView(R.layout.activity_retrofit_url_manager);
        ...
        findViewById(R.id.bt_request1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NetWorkManager
                        ...
                        .getOneApiService()
                        .getUsers(1, 10)
                        .compose(RetrofitUrlManagerActivity.this.<ResponseBody>getDefaultTransformer())
    ...
    /**
     * 什么是高级模式? 什么是 pathSegment? 建议先看看最上面的类注释! {@link RetrofitUrlManagerActivity}
     */
    public void startAdvancedModel(View view) {
        final EditText editText = new EditText(RetrofitUrlManagerActivity.this);
