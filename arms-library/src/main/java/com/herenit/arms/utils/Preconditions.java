...
public final class Preconditions {
     ...
     * @param greater 对比值
     * @param desc    对数值的描述
     * @return 如果source > greater 返回source，否则抛出异常
     */
    public static int checkIntGreaterThan(int source, int greater, String desc) {
        if (source > greater) {
            return source;
        } else {
            throw new ArithmeticException(desc + "=" + source + ",must greater than " + greater);
        }
    }

    /**
     * 判断某double类型的数值是否大于某个值
     *
     * @param source  要判断的数
     * @param greater 对比值
     * @param desc    对数值的描述
     * @return 如果source > greater 返回source，否则抛出异常
     */
    public static double checkDoubleGreaterThan(double source, int greater, String desc) {
        if (source > greater) {
            return source;
        } else {
            throw new ArithmeticException(desc + "=" + source + ",must greater than " + greater);
     ...
     * @return 如果source > greater 返回source，否则抛出异常
     */
    public static long checkLongGreaterThan(long source, long greater, String desc) {
        if (source > greater) {
            return source;
        } else {
            throw new ArithmeticException(desc + "=" + source + ",must greater than " + greater);
