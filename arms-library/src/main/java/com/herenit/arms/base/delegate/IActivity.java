 ...
 */
package com.herenit.arms.base.delegate;
...
import com.herenit.arms.integration.ActivityLifecycle;
import com.herenit.arms.integration.cache.Cache;
import com.herenit.arms.integration.cache.LruCache;
 ...
 *
 * @see BaseActivity
 * Created by herenitYan on 26/04/2017 21:42
...
public interface IActivity {
     ...
     * 重新创建, 那此缓存容器中的数据也会被清空, 如果你想避免此种情况请使用 <a href="https://github.com/herenitYanCoding/LifecycleModel">LifecycleModel</a>
     *
